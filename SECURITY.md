...
OpenKratos is currently unreleased on the v0 development line. There is no
...
Report vulnerabilities privately through the OpenKratos repository's
[security advisory form](https://github.com/openkratos/kratos/security/advisories/new).
Do not open a public issue or discussion before maintainers have assessed the
report.

Include:

- the affected OpenKratos version or commit;
...
OpenKratos-specific vulnerabilities should not be reported to upstream Kratos.
