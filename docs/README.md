# OpenKratos Documentation

## Current Behavior

- [Compatibility contract](../COMPATIBILITY.md)
- [Compatibility contract (Simplified Chinese)](../COMPATIBILITY_zh.md)
- [Migration from Kratos v3](migration/kratos-to-openkratos.md)
- [Migration from Kratos v3 (Simplified Chinese)](migration/kratos-to-openkratos_zh.md)
