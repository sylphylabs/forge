...
// This file defines the seam through which schema-aware behavior reaches the
// HTTP transport.
//
...
// application gets the schema behavior by importing the subpackage, which
...
// growing a field per capability: a new schema-aware behavior adds a method
...
// schemaCodec returns the codec to use for v, honoring the negotiated one for
